...
qs::qsave(trans, file = "data-raw/cache/trans.qs")
file.copy("data-raw/cache/trans.qs", "inst/extdata/trans.qs")

loss_data <- loss_run_all_evals(trans, merge = TRUE)

qs::qsave(loss_data, "data-raw/cache/loss_data.qs")
file.copy("data-raw/cache/loss_data.qs", "inst/extdata/loss_data_all.qs", overwrite = TRUE)
