...
RUN Rscript -e 'remotes::install_version("validate",upgrade="never", version = "1.1.1")'
...
RUN Rscript -e 'remotes::install_github("dreamRs/datamods@5d110eb33847104c3c8e077c5775cecbdb43118b")'
...
EXPOSE 80
CMD R -e "options('shiny.port'=80,shiny.host='0.0.0.0');actuarialapp::run_app()"
